...
def icon_ss_file_name(actor_info: ActorInfo) -> str:
    return f"{actor_info.actor_name}_{actor_info.actor_platform}(screenshot).png"


def icon_ss_file_path(actor_info: ActorInfo) -> str:
    return f"{Configs.formatIconFolderPath()}/{icon_ss_file_name(actor_info)}"
...
def smartActorIconSrc(actor_info: ActorInfo) -> str:
    ...
    # screenshot icon
    ss_file_path = icon_ss_file_path(actor_info)
    if os.path.exists(ss_file_path):
        return f"{Configs.FileWebPath}/{Configs.IconFolder}/{icon_ss_file_name(actor_info)}"
    # remote url
